...
const db_none = document.getElementById("wrap_redirect_ramdom");
const a = document.getElementById("wrap_content_no");
const nameRd = document.getElementById("name_ramdom");
...
rdlx.style.display = "none";

const yesClick = () => {
  container.style.display = "none";
  rdlx.style.display = "flex";
